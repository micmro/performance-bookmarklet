...
waterfall.setupTimeLine = function (durationMs, blocks, marks, lines, title) {
	...
	var createRect = (function (_createRect) {
		var _createRectWrapper = function createRect(_x, _x2, _x3, _x4, _x5) {
	...
	})(function (timeBlock, width, height, x, y) {
